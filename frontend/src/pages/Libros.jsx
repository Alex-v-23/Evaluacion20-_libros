...
import StudentForm from '../Components/LibrosForm'
          ...
          <table className="w-full border-collapse">
            ...
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-300 px-3 py-2 text-left">userId</th>
            ...
            <tbody>
              ...
              currentStudents.map((student) => (
                <tr key={student.id} className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-3 py-2">{student.userId}</td>
